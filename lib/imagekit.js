...
function getImageKit() {
    ...
    if (!privateKey || !publicKey || !urlEndpoint) {
        throw new Error("ImageKit env vars IMAGEKIT_PRIVATE_KEY, IMAGEKIT_PUBLIC_KEY, IMAGEKIT_URL are required");
    }
 ...
 */
async function uploadLocationImage(fileBuffer, fileName, mimeType) {
...
function getDisplayImageUrl(url, options) {
    ...
    const size = (options && options.size) || "show";
